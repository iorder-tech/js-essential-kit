 ...
 */
function brazilianZipcodeMask(value) {
    value = value.replace(/\D/g, '');
 ...
 */
const globalCellphoneMask = (country, phoneNumber) => {
    const selectCountry = countries_1.countries.find((item) => item.code === country);
...
exports.globalCellphoneMask = globalCellphoneMask;
/**
